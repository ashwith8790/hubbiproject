...
public class GoalDateChange implements RequestHandler<Request, Response>{
	
	private final TodoDaoImpl updategoaldateService = TodoDaoImpl.instance;
	...
	public Response handleRequest(Request input, Context context) {
		List<HubbiGoals> updatelist = updategoaldateService.updatedategoal(input);
